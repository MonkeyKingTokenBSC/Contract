...
/**                                                                                     
   Monkey King Token - The real community token!
   Everything will be decided by YOU!
   
   The point of the marketing wallet is to:
   
    - Finance the upcoming advertisements (PooCoin, Coinhunt)
    - Help the listing on Coinmarketcap and CoinGecko
    - Keep up the interest with influencers
   ...
   Official telegram: t.me/MonkeyKingTokenBSC
...
contract MonkeyKingToken is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x960C29A546646dADC6309A1AA907F841372d4DCf;
    ...
    string private _name = "Monkey King";
